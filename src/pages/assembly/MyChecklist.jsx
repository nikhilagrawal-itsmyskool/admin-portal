...
function TeacherChecklist() {
  ...
  return (
    <Box>
      ...
      {chk && <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>Week of {dates[0] ? fmtDay(dates[0]) : ''}</Typography>}
        ...
        return (
          <Card key={d} sx={{ mb: 2 }}>
            <CardContent>
              <Stack direction="row" justifyContent="space-between" alignItems="center" sx={{ mb: 1 }}>
                <Box>
                  <Typography variant="subtitle1" fontWeight={700}>{fmtDay(d)}</Typography>
